const Url = "http://192.168.10.100:5000"
const oldmanUrl = Url + '/oldperson_required';
const volunteerUrl = Url + '/volunteer_required';
const employeeUrl = Url + '/employee_required';
const oldpersonPostUrl = Url + '/oldperson';
const volunteerPostUrl = Url + '/volunteer';
const employeePostUrl = Url + '/employee'; 
const registerPostUrl = Url + '/register';
const loginUrl = Url + '/login';
const smileUrl = Url + '/smile';
const invadeUrl = Url + '/invade';
const forbiddenUrl = Url + '/interact';
const fallUrl = Url + '/fall';
const modify = Url + '/modify'
const videoFeed = "http://192.168.10.100:5000" + '/video_feed';
